                ...
                <div class="block-content">
                  <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                    ...
                    <form class="js-validation-signup" action="{{route('register')}}" method="POST">
                        ...
                        <div class="py-3">
                        <div class="mb-4">
                          <input type="text" class="form-control form-control-lg form-control-alt @error('name') is-invalid @enderror" id="name" name="name" placeholder="Username">
                            @error('name')
                        ...
                        <div class="mb-4">
                          <input type="password" class="form-control form-control-lg form-control-alt" id="password-confirm" name="password_confirmation" placeholder="Confirm Password" >
                        </div>
                        <div class="mb-4">

...
class TeacherController extends Controller
{
    ...
    {
        // $roles = Teacher::orderBy('id','DESC')->paginate(5);
        // return view('teachers.index',compact('teachers'))
        //     ->with('i', ($request->input('page', 1) - 1) * 5);
        
        // $roles = Role::where('status','active')->orderBy('id','DESC')->paginate(5);
    ...
    public function store(Request $request)
    {
        ...
        // // Attach permissions only if they exist
        // $existingPermissions = Permission::whereIn('id', $request->input('permission'))->get();
